...
function preload(){
  ...
  trex_collided = loadAnimation("assets/runner3.png");

  trex_running = loadAnimation("assets/2.jpg","assets/1.jpg","assets/3.jpg","assets/runner3.png","assets/runner2.png");
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    var obstacle = createSprite(1600,height-95,20,30);
